...
$(BIN_NAME).$(MEXEXT): dc1394_mex.cpp dc1394.cpp
	$(MEX) dc1394_mex.cpp dc1394.cpp `pkg-config --libs --cflags libdc1394-2` -output $(BIN_NAME).$(MEXEXT)

clean:
	@echo "Cleaning MEX files and object files"
	@rm *.mex* *.o *.txt 2> /dev/null; true
